...
Useful for quickly setting up a data collection stack.
...
By default, the app does not create any Grafana dashboards. An example dashboard that's configured to work with data collection(TODO Have to be added).
